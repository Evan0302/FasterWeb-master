F<template>
    ...
    >
        ...
        <ul class="project_detail">
                <li class="pull-left">
                    <router-link :to="'/fastrunner/api_record/'+ id" style="text-decoration: none; display: block; height: 100%;">
            ...
            <li class="pull-left">
                <router-link :to="'/fastrunner/auto_test/'+ id" style="text-decoration: none; display: block; height: 100%;">
            ...
            <li class="pull-left">
                <router-link :to="'/fastrunner/record_config/' + id" style="text-decoration: none; display: block; height: 100%;">
            ...
            <li class="pull-left">
                <router-link :to="'/fastrunner/global_env/' + id" style="text-decoration: none; display: block; height: 100%;">
        ...
        <ul class="project_detail">
            <li class="pull-left">
                <router-link :to="'/fastrunner/host_ip/' + id" style="text-decoration: none; display: block; height: 100%;">
            ...
            <li class="pull-left">
                <router-link :to="'/fastrunner/tasks/' + id" style="text-decoration: none; display: block; height: 100%;">
            ...
            <li class="pull-left">
                <router-link :to="'/fastrunner/reports/' + id" style="text-decoration: none; display: block; height: 100%;">
